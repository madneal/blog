...
![这里写图片描述](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/recovered/f2edab8ef912.jpg)

我无法理解他为什么要设置那个角度，我也不知道那个顶点的位置如何获取，如果有大神知道的，还望告知一下。
好，说完不好的，我就要说个我觉得很通俗易懂的模型，这是我第一个遇到一个我能看的懂，而且我又觉得具有实用意义的道路模型，首先如图所示：

![这里写图片描述](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/recovered/1f7e4389e5cd.jpg)
...
![这里写图片描述](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/recovered/54a0f34aa648.jpg)

这里的xm就是代表了原图中的边界线，同时我们根据道路模型的连续性，可以得出

![这里写图片描述](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/recovered/ef891506d1f0.jpg)

因为在xm两边的函数值是相等的，并且导数也是相等的。
从而我们就能得到下面的公式：

![这里写图片描述](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/recovered/3fd334005723.jpg)

这样我们可以把c和e用别的变量来表达

![这里写图片描述](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/recovered/ee697e109f32.jpg)

因此我们可以把最终的道路模型参数用下面的函数来表达

![这里写图片描述](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/recovered/8dc6d10a6343.jpg)
