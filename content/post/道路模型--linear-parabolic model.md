...
cover: "https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/covers/22322706b8ec790a8398.webp"
...
![这里写图片描述](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/d00b33719cf457db0fad.webp)

我无法理解他为什么要设置那个角度，我也不知道那个顶点的位置如何获取，如果有大神知道的，还望告知一下。
好，说完不好的，我就要说个我觉得很通俗易懂的模型，这是我第一个遇到一个我能看的懂，而且我又觉得具有实用意义的道路模型，首先如图所示：

![这里写图片描述](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/e16f93a102d5176f0476.webp)
...
![这里写图片描述](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/973abccb607bbdda3884.webp)

这里的xm就是代表了原图中的边界线，同时我们根据道路模型的连续性，可以得出

![这里写图片描述](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/ac862563a005188e9f0f.webp)

因为在xm两边的函数值是相等的，并且导数也是相等的。
从而我们就能得到下面的公式：

![这里写图片描述](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/4b08b2e5cbebb107e180.webp)

这样我们可以把c和e用别的变量来表达

![这里写图片描述](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/cc6dfcc521803eb9e950.webp)

因此我们可以把最终的道路模型参数用下面的函数来表达

![这里写图片描述](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/84c2c240362cc067c9f7.webp)
