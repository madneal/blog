...
![这里写图片描述](/img/content/54a0f34aa648.webp)

这里的xm就是代表了原图中的边界线，同时我们根据道路模型的连续性，可以得出

![这里写图片描述](/img/content/ef891506d1f0.webp)

因为在xm两边的函数值是相等的，并且导数也是相等的。
从而我们就能得到下面的公式：

![这里写图片描述](/img/content/3fd334005723.webp)

这样我们可以把c和e用别的变量来表达

![这里写图片描述](/img/content/ee697e109f32.webp)

因此我们可以把最终的道路模型参数用下面的函数来表达

![这里写图片描述](/img/content/8dc6d10a6343.webp)
