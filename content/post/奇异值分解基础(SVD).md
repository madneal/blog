...
title: "奇异值分解基础(SVD)"
author: Neal
summary: "本文围绕《奇异值分解基础(SVD)》展开，重点梳理特征值和特征向量、奇异值和SVD和PCA等内容，提炼背景、思路与实践注意点。"
cover: "https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/covers/7453c1fa270b7517fdb6.webp"
...
![这里写图片描述](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/89a3f9a6d98b0c31748d.webp)

很显然，λ就是特征向量v对应的特征值，一个矩阵的一组特征向量都是相互正交的，相信这些大家在线性代数都有学习。特征值分解是将一个矩阵以下面的形式进行分解：

![这里写图片描述](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/a417a70af9d0ed18f502.webp)
...
![这里写图片描述](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/31a62ae69f497a6258b2.webp)
...
![这里写图片描述](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/5f261072f2b2df0ab164.webp)

我们将矩阵A和他的转置矩阵相乘，就可以得到一个方阵，我们利用方阵的求特征值可以得到：

![这里写图片描述](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/c28e5d188760e0d00b6f.webp)

这里面的v，就是我们上面所说的右奇异向量，由此我们可以得到

![这里写图片描述](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/563a1a5efc534f2bacce.webp)
...
![这里写图片描述](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/0be63c463131007703b4.webp)

r是一个远小于m、n的数，

![这里写图片描述](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/c3836e4331b8c54ebbb8.webp)
...
![这里写图片描述](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/e10698fac6876eb99d0d.webp)
...
![这里写图片描述](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/70ddf3178755905311d5.webp)

而将一个m*n的矩阵A变成一个m*r的矩阵，我们就会使得本来有n个feature的，变成有r个feature了(r小于n)，这r个其实就是对n个feature的一种提炼，我们把这个称为feature的压缩：
之前的SVD的式子是：

![这里写图片描述](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/9e5de766c3d3927ffdd2.webp)
...
![这里写图片描述](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/0ff4563cf3456284f3b7.webp)
