...
![SQL 盲注](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/recovered/csdn-e3326aa4f5c0f87151f77beae66e99da.png)

看到这里，你可能还是一头雾水，与运算和盲注有啥关系？假设一个数字 104，我们可以将它转化为二进制，即 `104 = 64 + 32 + 8 = 2 ^ 6 + 2 ^ 5 + 2 ^ 3`，我们可以将它以比特位的形式将它表示出来：

![SQL 盲注位运算](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/recovered/csdn-7cfafec0c46e8ed2d05ed97a05710cb7.png)

那么我们可以将104与 `1，2，4，8，16，32，64，128` 进行与运算，就可以获得每个比特位上的数据。

与1进行运算

![SQL 盲注与 1](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/recovered/csdn-346b74171416bacfb23eb42b2fe3e90d.png)

和2进行与运算

![SQL 盲注与 2](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/recovered/csdn-22ee7d79987dd45bcc2dd8412b2b0499.png)

和4进行与运算

![SQL 盲注与 4](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/recovered/csdn-43650a556d49dba38b575a28ab8e5b36.png)
...
![SQL 盲注结果](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/recovered/csdn-eb4e0de36a2a53fdf9620b71122aaa90.png)
