...
> **（配图未能自动恢复）** 原地址：`https://s1.ax1x.com/2020/04/19/JuhTS0.png`

看到这里，你可能还是一头雾水，与运算和盲注有啥关系？假设一个数字 104，我们可以将它转化为二进制，即 `104 = 64 + 32 + 8 = 2 ^ 6 + 2 ^ 5 + 2 ^ 3`，我们可以将它以比特位的形式将它表示出来：

> **（配图未能自动恢复）** 原地址：`https://s1.ax1x.com/2020/04/19/JuhOw4.png`

那么我们可以将104与 `1，2，4，8，16，32，64，128` 进行与运算，就可以获得每个比特位上的数据。

与1进行运算

> **（配图未能自动恢复）** 原地址：`https://s1.ax1x.com/2020/04/19/Ju4k0e.png`

和2进行与运算

> **（配图未能自动恢复）** 原地址：`https://s1.ax1x.com/2020/04/19/Ju4ZtA.png`

和4进行与运算

> **（配图未能自动恢复）** 原地址：`https://s1.ax1x.com/2020/04/19/Ju4efI.png`
...
> **（配图未能自动恢复）** 原地址：`https://s1.ax1x.com/2020/04/19/Ju4MX8.png`
