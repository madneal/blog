...
cover: "https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/covers/ba2997b54cab8723af89.webp"
tags: [安全, Web安全]
...
![SQL 盲注](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/a7bc680255c4dda3cf1b.webp)

看到这里，你可能还是一头雾水，与运算和盲注有啥关系？假设一个数字 104，我们可以将它转化为二进制，即 `104 = 64 + 32 + 8 = 2 ^ 6 + 2 ^ 5 + 2 ^ 3`，我们可以将它以比特位的形式将它表示出来：

![SQL 盲注位运算](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/b4c51ba931b23251fc87.webp)

那么我们可以将104与 `1，2，4，8，16，32，64，128` 进行与运算，就可以获得每个比特位上的数据。

与1进行运算

![SQL 盲注与 1](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/ca26c26d71b560cf876e.webp)

和2进行与运算

![SQL 盲注与 2](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/ae3bc6e17ec68bedd9a8.webp)

和4进行与运算

![SQL 盲注与 4](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/831c703662139b957ac6.webp)
...
![SQL 盲注结果](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/b5af555b65a23b924ff8.webp)
