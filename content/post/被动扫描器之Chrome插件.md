...
![Chrome webRequest 请求生命周期](/img/content/tencent-yehe-1268449-m1p4neb5u8.webp)
...
![Burp Extender API](/img/content/tencent-yehe-1268449-bdthhcvn7k.webp)
...
![Burp IHttpListener](/img/content/tencent-yehe-1268449-186vc5fam5.webp)
...
![Burp 插件调试](/img/content/tencent-yehe-1268449-5t4enfmeqa.webp)

其实，我认为在 Burp 插件开发过程中最重要的部分就是调试了。通过调试可以快速提高开发效率。以 IDE IDEA 为例，只需要以下几步就可以进行插件开发地调试：

1. 配置 debug 配置项，点击 IDE 右上角就可以新增配置项。

![IDEA Remote 调试配置](/img/content/csdn-burp-debug-config.webp)
...
![Burp 插件调试结果](/img/content/csdn-3d16835ddc318893428d5bc360e06169.webp)
