...
cover: "https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/covers/2e57a0bcaeae60c36b09.webp"
...
![Chrome webRequest 请求生命周期](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/26a0c5c0ec0e67f137fc.webp)
...
![Burp Extender API](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/3b45ffde7a4564615285.webp)
...
![Burp IHttpListener](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/5aac8df11b430cf160d7.webp)
...
![Burp 插件调试](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/17ed08f38219c3ccf9e1.webp)

其实，我认为在 Burp 插件开发过程中最重要的部分就是调试了。通过调试可以快速提高开发效率。以 IDE IDEA 为例，只需要以下几步就可以进行插件开发地调试：

1. 配置 debug 配置项，点击 IDE 右上角就可以新增配置项。

![IDEA Remote 调试配置](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/fb5ad2b0745c063c74a1.webp)
...
![Burp 插件调试结果](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/fba4d6125d353336cfcd.webp)
