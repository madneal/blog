...
title: "XSS 漏洞知解 123"
author: Neal
summary: "本文围绕《XSS 漏洞知解 123》展开，重点梳理典型利用场景、盗取 cookie和通过 XSS 来实现 CSRF等内容，提炼背景、思路与实践注意点。"
cover: "https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/covers/ea03ca8025b1865318d0.webp"
tags: [安全, Web安全, 漏洞分析]
...
![Burp Collaborator](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/e53243322c38cb1b8045.webp)

进入到 Collobrator Client，点击 Copy to clipborad 就可以将服务地址复制到剪切板。我们可以使用 curl 来进行测试：

![Burp Collaborator 配置](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/01a2ed3995bbf702cac6.webp)
...
![XSS 测试](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/569b1f4364a5b3598b86.webp)

下面我们只需要打开浏览器开发者工具，总控制台中输入 `document.cookie = 'session=Xn8ow3pdmd6LWktVZPJtBlI9yKzIKUX3'`，刷新一下页面，我们就成为管理员了。

![XSS payload](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/17d2b373772bde987d7f.webp)
...
![Cookie 读取结果](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/8a845dfa4a34cebd69f9.webp)
...
![CSRF 实验](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/155f45f8e517813b8bee.webp)
