...
> **（配图未能自动恢复）** 原地址：`https://s2.ax1x.com/2020/02/19/3ExZJH.png`

进入到 Collobrator Client，点击 Copy to clipborad 就可以将服务地址复制到剪切板。我们可以使用 curl 来进行测试：

> **（配图未能自动恢复）** 原地址：`https://s2.ax1x.com/2020/02/19/3Exlef.png`
...
> **（配图未能自动恢复）** 原地址：`https://s2.ax1x.com/2020/02/25/3tuMAU.gif`

下面我们只需要打开浏览器开发者工具，总控制台中输入 `document.cookie = 'session=Xn8ow3pdmd6LWktVZPJtBlI9yKzIKUX3'`，刷新一下页面，我们就成为管理员了。

> **（配图未能自动恢复）** 原地址：`https://s2.ax1x.com/2020/02/27/3ax38K.png`
...
> **（配图未能自动恢复）** 原地址：`https://s2.ax1x.com/2020/02/27/3axGvD.png`
...
> **（配图未能自动恢复）** 原地址：`https://s2.ax1x.com/2020/03/01/3cJFkq.png`
