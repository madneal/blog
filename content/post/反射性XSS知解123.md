...
cover: "/img/post-covers/xss-123-cf257bd696.jpg"
tags: [安全, Web安全, 漏洞分析]
...
![Burp Collaborator](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/recovered/csdn-937bfe1ee247fe18ba68f81ada2b8f44.png)

进入到 Collobrator Client，点击 Copy to clipborad 就可以将服务地址复制到剪切板。我们可以使用 curl 来进行测试：

![Burp Collaborator 配置](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/recovered/csdn-86b6051721073948f91029129925dd0c.png)
...
![XSS 测试](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/recovered/csdn-736fdccf88f79a79533c826fcce91991.png)

下面我们只需要打开浏览器开发者工具，总控制台中输入 `document.cookie = 'session=Xn8ow3pdmd6LWktVZPJtBlI9yKzIKUX3'`，刷新一下页面，我们就成为管理员了。

![XSS payload](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/recovered/csdn-77c35509e2bcfa253788b7cde977ad37.png)
...
![Cookie 读取结果](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/recovered/csdn-32026cbd61c23fe78c5847747f1b825f.png)
...
![CSRF 实验](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/recovered/csdn-85d4d3d601100e81b97403b713a37982.png)
