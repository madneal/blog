...
cover: "https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/covers/7fb631c60af508ad9796.webp"
...
![Canny边缘检测](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/943dc98d286f32a30b81.webp)
...
![直线检测](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/4f7f9fad671ff3abfc2c.webp)
...
![检测到的消失点](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/fbd31ce9edea48e6171f.webp)

 对于每个图像分割部分来说，它的消失点由地平线附近投票最多的点所决定。所有检测到的消失点可以再图4b中看到。注意一点，对于图像部分5，没有消失点存在，因为在这个图像分割部分并没有检测到直线。
 

![(a)图像分割部分2的消失点(b)所有图像分割部分中检测到的消失点](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/ae9be631bfa4d460ab68.webp)
...
![这里写图片描述](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/5cf83edafdfb2672b78d.webp)
...
![这里写图片描述](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/c2e9bc39b8a339eb4c7e.webp)
...
![图5 作为道路特征选择的直线](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/30b2c6a5f6c270039ad7.webp)

 ![控制点初始化]
 ([已移除失效外链])

![图6](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/efc73a456cd984b9bab5.webp)

 ## 实验结果##
 

![图7](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/14574fd37951274ccbdb.webp)
