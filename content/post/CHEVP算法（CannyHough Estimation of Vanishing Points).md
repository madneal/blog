...
cover: "/img/post-covers/chevp-vanishing-ad2f3ea6c3.jpg"
...
![Canny边缘检测](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/recovered/a15e161ac67a.gif)
...
![直线检测](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/recovered/5a0e7cb7d132.gif)
...
![检测到的消失点](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/recovered/519ce07fd685.gif)

 对于每个图像分割部分来说，它的消失点由地平线附近投票最多的点所决定。所有检测到的消失点可以再图4b中看到。注意一点，对于图像部分5，没有消失点存在，因为在这个图像分割部分并没有检测到直线。
 

![(a)图像分割部分2的消失点(b)所有图像分割部分中检测到的消失点](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/recovered/6707e5c6fb5c.gif)
...
![这里写图片描述](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/recovered/2be07bafdc3e.jpg)
...
![这里写图片描述](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/recovered/b3d7926c3a53.jpg)
...
![图5 作为道路特征选择的直线](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/recovered/4cde4400a624.gif)

 ![控制点初始化]
 ([已移除失效外链])

![图6](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/recovered/06742f1ba5c0.gif)

 ## 实验结果##
 

![图7](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/recovered/774c94140d16.gif)
