...
![Canny边缘检测](/img/content/a15e161ac67a.webp)
...
![直线检测](/img/content/5a0e7cb7d132.webp)
...
![检测到的消失点](/img/content/519ce07fd685.webp)

 对于每个图像分割部分来说，它的消失点由地平线附近投票最多的点所决定。所有检测到的消失点可以再图4b中看到。注意一点，对于图像部分5，没有消失点存在，因为在这个图像分割部分并没有检测到直线。
 

![(a)图像分割部分2的消失点(b)所有图像分割部分中检测到的消失点](/img/content/6707e5c6fb5c.webp)
...
![这里写图片描述](/img/content/2be07bafdc3e.webp)
...
![这里写图片描述](/img/content/b3d7926c3a53.webp)
...
![图5 作为道路特征选择的直线](/img/content/4cde4400a624.webp)

 ![控制点初始化]
 ([已移除失效外链])

![图6](/img/content/06742f1ba5c0.webp)

 ## 实验结果##
 

![图7](/img/content/774c94140d16.webp)
