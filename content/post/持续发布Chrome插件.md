...
cover: "https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/covers/37a51f19c2487b1e83d2.webp"
tags: [安全, 安全开发, 前端, 工程化]
categories: [开发]
date: "2019-05-27"
---
...
![创建 Google API 项目](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/9d9be711e1d8204afd40.webp)

在创建项目之后，我们需要开启 "Chrome Web Store API"。在 Library 中搜索这个 API， 并且将其 ENABLE。

![启用 Chrome Web Store API](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/d92676f84b57fc93ead0.webp)

在 ENABLE 这个 API 之后，就可以点击 "CREATE CREDENTIALS" 创建口令了。确保你已经选择了对应创建的 project。值得注意的一点是，你创建的应该是 OAuth client ID 类型的，确保你选择了正确的类型。

![创建 OAuth 凭据](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/4a3554942f8095266d9d.webp)
...
![OAuth consent screen](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/594ffed7cd43ecdba868.webp)
...
![获取授权 code](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/379a8bffac79f8394af7.webp)
...
![获取 refresh token](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/948c4a1642b255194516.webp)
...
![CircleCI 环境变量](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/db586f2d6563abbd0a93.webp)
