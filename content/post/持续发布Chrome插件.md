...
![创建 Google API 项目](/img/content/csdn-d75b676019b94622efbd73830500c191.webp)

在创建项目之后，我们需要开启 "Chrome Web Store API"。在 Library 中搜索这个 API， 并且将其 ENABLE。

![启用 Chrome Web Store API](/img/content/csdn-a389945342de66c7dca1fe3e3cbd6bff.webp)

在 ENABLE 这个 API 之后，就可以点击 "CREATE CREDENTIALS" 创建口令了。确保你已经选择了对应创建的 project。值得注意的一点是，你创建的应该是 OAuth client ID 类型的，确保你选择了正确的类型。

![创建 OAuth 凭据](/img/content/csdn-c902bc19a9d1fd5b3a8d56a86c7aa8bd.webp)
...
![OAuth consent screen](/img/content/csdn-3e873b42d2850581ba1cc0109f1accb9.webp)
...
![获取授权 code](/img/content/csdn-24ac3cd33b0998141ef6e23e01bcf430.webp)
...
![获取 refresh token](/img/content/csdn-780c26a4093d06f0c3fb6736eb84c5bc.webp)
...
![CircleCI 环境变量](/img/content/csdn-4025341d7146ce4d4aa6a8fa47fa07fc.webp)
