...
cover: "https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/covers/0764afae2a15803337ae.webp"
...
源码阅读三部曲：入口地图 → 核心模式 → 其余模块对照。完成后试着提一个小 PR 或写自己的最小爆破器，知识才算内化。
