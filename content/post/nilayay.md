...
cover: "https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/covers/fff706cf8a7eb927a200.webp"
tags: [安全, 代码审计, Go]
categories: [开发]
date: "2024-11-30"
---
...
![配图](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/2de83a7c940177a999a7.webp)
...
![Figure 1: Nil panic error message](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/7bc141862f293a4c78f7.webp)
...
![Figure 2: Fix commit from golang/go fixing a nil panic in its net package (PR #60823). The nil panic is caused by calling method String() on the return of RemoteAddr() on L1859, which can be a nil interface value (as shown in Figure 3)](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/e3a11297c87ecc838ddf.webp)
...
![Figure 3: Excerpt from net/net.go showing the net.Conn interface and the implementation of the RemoteAddr() method by the struct net.conn, which can return nil, if c.ok() is false](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/ec5f057a8a0b930eb36f.webp)
...
![Figure 4: Excerpt from the implication graph built by NilAway representing the nil flow for the example in Figure 2.](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/95e527467a839762bc22.webp)
...
![Figure 5: Error message reported by NilAway for the unsafe flow in Figure 2](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/1054b88c702f1833fe73.webp)
...
![Figure 6: Architecture of NilAway.](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/d2bfb82073a38c51d7fc.webp)
...
![Figure 7: Simplified and redacted code excerpt from an internal Uber service logging 3000+ nil panics per day in production.](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/9ef99e8c5ae3800524a3.webp)
...
![Figure 8: Complete addressal of the 3000+ nil panics being logged per day in production.](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/284fb11034a65cfb78c2.webp)
