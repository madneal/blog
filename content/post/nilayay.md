...
cover: "/img/post-covers/nilayay-78e9ed4841.jpg"
tags: [安全, 代码审计, Go]
categories: [开发]
date: "2024-11-30"
---
...
![配图](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/recovered/fix-nilaway-cover.jpg)
...
![Figure 1: Nil panic error message](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/recovered/fix-nilaway-figure-1.jpg)
...
![Figure 3: Excerpt from net/net.go showing the net.Conn interface and the implementation of the RemoteAddr() method by the struct net.conn, which can return nil, if c.ok() is false](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/recovered/fix-nilaway-figure-3.jpg)
...
![Figure 4: Excerpt from the implication graph built by NilAway representing the nil flow for the example in Figure 2.](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/recovered/fix-nilaway-figure-4.jpg)
...
![Figure 5: Error message reported by NilAway for the unsafe flow in Figure 2](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/recovered/fix-nilaway-figure-5.jpg)
...
![Figure 6: Architecture of NilAway.](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/recovered/fix-nilaway-figure-6.jpg)
...
![Figure 7: Simplified and redacted code excerpt from an internal Uber service logging 3000+ nil panics per day in production.](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/recovered/fix-nilaway-figure-7.jpg)
...
![Figure 8: Complete addressal of the 3000+ nil panics being logged per day in production.](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/recovered/fix-nilaway-figure-8.jpg)
