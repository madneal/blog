...
![配图](/img/content/fix-nilaway-cover.webp)
...
![Figure 1: Nil panic error message](/img/content/fix-nilaway-figure-1.webp)
...
![Figure 2: Fix commit from golang/go fixing a nil panic in its net package (PR #60823). The nil panic is caused by calling method String() on the return of RemoteAddr() on L1859, which can be a nil interface value (as shown in Figure 3)](/img/content/fix-nilaway-figure-2.webp)
...
![Figure 3: Excerpt from net/net.go showing the net.Conn interface and the implementation of the RemoteAddr() method by the struct net.conn, which can return nil, if c.ok() is false](/img/content/fix-nilaway-figure-3.webp)
...
![Figure 4: Excerpt from the implication graph built by NilAway representing the nil flow for the example in Figure 2.](/img/content/fix-nilaway-figure-4.webp)
...
![Figure 5: Error message reported by NilAway for the unsafe flow in Figure 2](/img/content/fix-nilaway-figure-5.webp)
...
![Figure 6: Architecture of NilAway.](/img/content/fix-nilaway-figure-6.webp)
...
![Figure 7: Simplified and redacted code excerpt from an internal Uber service logging 3000+ nil panics per day in production.](/img/content/fix-nilaway-figure-7.webp)
...
![Figure 8: Complete addressal of the 3000+ nil panics being logged per day in production.](/img/content/fix-nilaway-figure-8.webp)
