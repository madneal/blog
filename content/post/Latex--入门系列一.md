...
![formula](/img/content/fix-latex-s1-formula.webp)
...
LaTeX最近通用![latex-v](/img/content/fix-latex-s1-latex2e.webp)经常写作是LaTeX2e。我认为你是在使用这个版本的。通常这也无关紧要，但是有一些老的命令我不会特别提及。
