...
cover: "https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/covers/850fb3169bd4e1e65c81.webp"
tags: [安全, Web安全, 漏洞分析]
keywords: [XSS,web安全]
categories: [安全]
date: "2019-11-24"
...
![AMP4Email playground](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/630dd2e109c54fb6aec6.webp)

图1. AMP4Email playground

如果你尝试添加验证器未明确允许的任何 HTML 元素或属性，则会收到错误消息。

![AMP 验证器](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/b566a155d56c74a6fc0e.webp)

图2. AMP 验证器禁止使用任意脚本标签

在使用 AMP4Email 并尝试各种方法绕过它时，我注意到标签中不允许 id 属性（图3）。

![AMP4Email id 属性限制](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/cda13fb33ec2597bc675.webp)
...
![window.test1 指向 HTMLCollection](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/77197c7ccb94f09fcedd.webp)
...
![window.test1.test2 属性](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/0d9e1694e59454945b8f.webp)
...
![window 全局对象属性](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/37c8d2b56cbc3f670ae8.webp)

图6. window 全局对象的属性

在这一点上，事实证明 AMP4Email 实际上对 DOM Clobbering 采取了某种保护措施，因为它严格禁止 id 属性的某些值，例如：`AMP`（图7）。

![AMP 无效的 id 值](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/6ac907401742f1d6c24e.webp)
...
![AMP4Email 脚本加载 404](https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/content/b7895fb365074ba8e1be.webp)
