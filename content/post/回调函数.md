...
title: "回调函数"
author: Neal
summary: "本文围绕《回调函数》展开，重点梳理回调函数、回调函数的机制和为什么要使用回调函数等内容，提炼背景、思路与实践注意点。"
cover: "https://cdn.jsdelivr.net/gh/madneal/blog-image@main/images/optimized/covers/4a566cf50f894839b94b.webp"
