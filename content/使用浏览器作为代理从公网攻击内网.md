...
**对于开发者**, 你可以做的最重要的事情是确保你的软件能够抵御 CSRF 攻击。 可以在网络上 \[26\] 上找到实现 CSRF保护 的入门指南。

此外，开发人员通常需要运行普通用户不需要的各种服务，例如数据库，Jenkins 等。确保这些服务不易受到 CSRF攻 击，并且通常安全地配置它们。（这些服务的安全配置可能比安装最新补丁更重要。在作者的渗透测试经验中，由于配置不安全而导致系统崩溃，相对于缺少补丁来说更常见。）
